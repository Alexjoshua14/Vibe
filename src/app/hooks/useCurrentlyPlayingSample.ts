...
export const useCurrentlyPlaying = () => {
  const currentlyPlaying = {
    ...
    "queue":{"id":"clojeb814000gp4axqg3r3nsf",
    "updatedAt":"2023-11-04T01:58:37.672Z"},
    "suggested":{"id":"clomchsj900072j2of933e5yq",
  ...
  const progress =  {"time":362666,
  "percentage":100}
  const imageURL = "https://i.scdn.co/image/ab67616d0000b2737f0fb0f6082a74998505fe8f"
